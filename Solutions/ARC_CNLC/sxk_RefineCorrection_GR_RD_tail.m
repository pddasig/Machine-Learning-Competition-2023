function  [pickA1,pickBB,flags] = sxk_RefineCorrection_GR_RD_tail(a1,b1,pickA0,s1_scope,p1_refine,tensile_pool,pad_numval)
...
jud_loga = a1log~=pad_numval | a1log~=2.*pad_numval;
jud_logb = b1log~=pad_numval | b1log~=2.*pad_numval;
...
obj2d   = sub_ObjFun_FrontPart_retune_GR_RD(loga1_tar,logb1_tar,pickA1_rel,pickB1s_rel,tensile_pool,min_coverlen);
