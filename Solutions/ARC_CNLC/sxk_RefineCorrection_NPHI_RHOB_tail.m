...
jud_loga = a1.trend~=pad_numval & (a1log~=2.*pad_numval | a1log~=pad_numval);
jud_logb = b1.trend~=pad_numval & (b1log~=2.*pad_numval | b1log~=pad_numval);
...
space_L2 = 1;
pickB2set = sub_deterimineBpicks(pickB1,space_L1*3,idxvec_Beff,b1log_eff+b2log_eff,space_L2);
