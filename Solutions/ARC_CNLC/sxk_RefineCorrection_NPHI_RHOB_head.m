function  [pickA1,pickBB,flags] = sxk_RefineCorrection_NPHI_RHOB_head(a1,b1,pickA0,s1_scope,p1_refine,tensile_pool,pad_numval)
...
obj2d   = sub_ObjFun_LaterPart_retune_GR_NPHI(loga1_tar,logb1_tar,pickA1_rel,pickB1s_rel,tensile_pool,min_coverlen);
...
obj2d   = sub_ObjFun_LaterPart_retune_GR_NPHI(loga2_tar,logb2_tar,pickA1_rel,pickB2s_rel,tensile_pool,min_coverlen);
[maxval,maxidx1d] = max(obj2d(:));
[maxridx,maxcidx] = ind2sub(size(obj2d),maxidx1d);
obj2d_mf          = medfilt2(obj2d,[11 11]);
