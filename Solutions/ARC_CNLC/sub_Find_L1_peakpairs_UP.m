function  [pickAi,pickBi,isend] = sub_Find_L1_peakpairs_UP(loga0_trend,logb0_trend,PickSets,pickA0,pickB0,L1_search_nrad,proc_warplen)
...
loga00 = loga0_trend(pickAi:pickA0);
...
obj_si = zeros(ntry,1);  
for it = 1:1:ntry    
    logb00 = logb0_trend(pickBis(it):pickB0);    
    rate = length(logb00)./length(loga00);
    if rate<0.50 || rate>2.0 || isempty(logb00)==1
        continue;
    end    
...
logb00 = logb0_trend(pickBi:pickB0);  
if isempty(logb00)==0
