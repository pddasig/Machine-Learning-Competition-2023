function  [pickA1,pickBB,flag] = sxk_RefineCorrection_NPHI_RHOB(a1,b1,pickA0,s1_scope,p1_refine,tensile_pool,pad_numval)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nrad_retune  = 8.*s1_scope; %% log segments for comparsion
...
obj2d_later   = sub_ObjFun_LaterPart_retune_GR_RD(loga1_tar,logb1_tar,pickA1_rel,pickB1s_rel,tensile_pool,min_coverlen);
obj2d_front   = sub_ObjFun_FrontPart_retune_GR_RD(loga1_tar,logb1_tar,pickA1_rel,pickB1s_rel,tensile_pool,min_coverlen);
% % % obj2d_later = obj2d_later - median(obj2d_later,2);
% % % obj2d_front = obj2d_front - median(obj2d_front,2);
obj2d         = obj2d_later + obj2d_front;

% % % % %%%% test the front part
% % % % idxvec     = flipud([1:1:length(loga1_tar)].');
% % % % loga2_tar  = flipud(loga1_tar(:));
% % % % logb2_tar  = flipud(logb1_tar(:));
% % % % pickA2_rel = idxvec(pickA1_rel);
% % % % pickB2s_rel = idxvec(pickB1s_rel);
% % % % obj2d_front2   = sub_ObjFun_FrontPart_retune_GR_RD(loga2_tar,logb2_tar,pickA2_rel,pickB2s_rel,tensile_pool,min_coverlen);


obj2d_mf3 = medfilt2(obj2d,[5 5]);
[~,maxidx1d] = max(obj2d(:)+obj2d_mf3(:));
...
% % % obj2d_later   = sub_ObjFun_LaterPart_retune_GR_RD(loga2_tar,logb2_tar,pickA1_rel,pickB2s_rel,tensile_pool,min_coverlen);
% % % obj2d_front   = sub_ObjFun_FrontPart_retune_GR_RD(loga2_tar,logb2_tar,pickA1_rel,pickB2s_rel,tensile_pool,min_coverlen);
% % % obj2d = obj2d_later + obj2d_front;
