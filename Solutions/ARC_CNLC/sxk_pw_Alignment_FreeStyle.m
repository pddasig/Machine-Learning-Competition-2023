function  [blog_out,bdep_ori,alog_out,adep_out] = sxk_pw_Alignment_FreeStyle(pickpairs,suba0,subb0,dep_suba0,dep_subb0,pad_numval)
...
bdep_head = head_tmpl;
bdep_head(end-nb_head+1:end) = dep_subb0(1:1:nb_head); %%% original depth of b
alog_head = head_tmpl;
...
bdep_tail = tail_tmpl;
bdep_tail(1:nb_tail) = dep_subb0(pickpairs(end,2)+1:1:end);
