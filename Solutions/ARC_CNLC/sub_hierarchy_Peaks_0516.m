function  [pidx_L3,pidx_L2,pidx_L1,pidx0] = sub_hierarchy_Peaks_0516(loga0_detail,nrad_scope,nrad_bg,L3,L2,L1)
...
% plot(login);
% hold on;
% plot(pidx0(isL3),peak_amps(isL3),'r*');


head_part = [1:8:128];
tail_part = [ndepth-128:8:ndepth];
pidx_L1 = unique([head_part(:); pidx0(isL1);tail_part(:)]);
