function  [bx,bd,bc,ac,PPairs_s0,PPairs_s1] = sxk_combo_PickPairs_Correction(b0,a0,s0_scope,s1_scope,pad_numval)
...
[AS0,BS0] = DTW_newobj_v2_step01(a0.trend,b0.trend,A0picks,B0picks,s0_scope);
PPairs_s0 = [AS0,BS0];
...
PPairs_s1    = sxk_PopUp_PickPairs_Moderate(a1r,b1r,s1_scope,pad_numval);
