function  pickpairs = sxk_PopUp_PickPairs_V2_all(a1,b1,s0_scope,s1_scope,pad_numval)
...
for it = 1:1:ntimes      
    ...
    ailog_iter = a1_iter.trend + a1_iter.detail;
    bilog_iter = b1_iter.trend + b1_iter.detail;    
