function  [pickpairs_out,flags_out,a1r,b1r] = sxk_PopUp_PickPairs_V3_OBJ(a1,b1,s0_scope,s1_scope,pad_numval)
...
[pickA1,pickB1,flag1] = sxk_RefineCorrection_GR_NPHI_head(a1,b1,a1idx_head,s1_scope,p1_refine,tensile_pool,pad_numval);
[pickA2,pickB2,flag2] = sxk_RefineCorrection_GR_NPHI_tail(a1,b1,a1idx_tail,s1_scope,p1_refine,tensile_pool,pad_numval);
...
jud_standout = (flags>=0.125 & flags<10) & isinf(abs(flags))==0  ;
